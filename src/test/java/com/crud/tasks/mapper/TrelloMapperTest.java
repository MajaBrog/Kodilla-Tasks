...
public class TrelloMapperTest {
    ...
    public void trelloMapToBoardsTest() {
        ...
        TrelloBoardDto trelloBoardDto = new TrelloBoardDto("id", "test board", new ArrayList<>());
    ...
    public void trelloMapToBoardsDtoTest() {
        //Given
        TrelloMapper trelloMapper = new TrelloMapper();
        TrelloBoard trelloBoard = new TrelloBoard("id", "test board", new ArrayList<>());
    ...
    public void trelloMapToListTest() {
        //Given
        TrelloMapper trelloMapper = new TrelloMapper();
        TrelloListDto trelloListDto = new TrelloListDto("id", "test board", true);
    ...
    public void trelloMapToListDtoTest() {
        //Given
        TrelloMapper trelloMapper = new TrelloMapper();
        TrelloList trelloList = new TrelloList("id", "test list", true);
    ...
    public void trelloMapToCardDtoTest() {
        //Given
        TrelloMapper trelloMapper = new TrelloMapper();
        TrelloCard trelloCard = new TrelloCard("id", "test list", "pos", "listId");
        //When
    ...
    public void trelloMapToCardTest() {
        //Given
        TrelloMapper trelloMapper = new TrelloMapper();
        TrelloCardDto trelloCardDto = new TrelloCardDto("id", "test list", "pos", "listId");
        //When
